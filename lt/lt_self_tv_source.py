...
from utils.mq import SourceToRaffleMQ
    ...
    async def parse_single_message(self, area_id, room_id, message):
        ...
        if cmd == "PREPARING":
            ...
            if matched_notice_area:
                ...
                r = await SourceToRaffleMQ.put(danmaku=message, created_time=time.time(), msg_from_room_id=real_room_id)
            ...
            await SourceToRaffleMQ.put(danmaku=message, created_time=time.time(), msg_from_room_id=room_id)
